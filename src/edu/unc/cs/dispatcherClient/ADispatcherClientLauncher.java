...
import gradingTools.server.ADriverServerLauncher;
import gradingTools.server.ADriverServerObject;
...
public class ADispatcherClientLauncher extends AnAbstractDuplexRPCClientPortLauncher  implements DispatcherClientLauncher{
	...
	public ADispatcherClientLauncher(String aServerHost, String aServerId) {
		super(DispatcherClientLauncher.CLIENT_NAME, aServerHost, aServerId, DriverServerLauncher.DRIVER_SERVER_NAME);
			
	}
	public ADispatcherClientLauncher(String aServerHost) {
		super(DispatcherClientLauncher.CLIENT_NAME, aServerHost, DriverServerLauncher.DRIVER_SERVER_ID, DriverServerLauncher.DRIVER_SERVER_NAME);
...
//				Thread.sleep(1000);
	...
	public static void main (String[] args) {
		...
		if (aClient != null) {
			aClient.getDispatcherRegistry().registerDriverServer(new ADriverServerObject());			
		}
